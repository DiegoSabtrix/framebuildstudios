  ...
  return <>
    ...
    <main id="top">
      ...
      <section id="contact" className="contact section-pad">
        <div className="contact-heading"><h2>{c.formTitle}</h2><p>{c.formIntro}</p><div className="contact-detail"><span>Miami, Florida</span><a href="mailto:hello@framebuildstudios.com" onClick={() => track("click_email")}>hello@framebuildstudios.com</a></div></div>
